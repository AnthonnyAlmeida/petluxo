...
export const PRODUCTS = [
  ...
  },
  {
    ...
    order: 44,
    categoryOrder: {"mais-vendidos":1300,"conforto":1400},
  ...
  },
  {
    ...
    category: ['mais-vendidos', 'conforto'],
    order: 34,
    categoryOrder: {"mais-vendidos":1500,"conforto":1500},
  ...
  },
  {
    ...
    prices: [{ size: 'M', price: 'R$ 597,00' }, { size: 'G', price: 'R$ 697,00' }],
    originalPrice: null,
    category: ['couro'],
    order: 43,
    categoryOrder: {"couro":1100},
    image: '/images/products/executive_bed.webp',
    badge: null,
    buyLinks: [{ size: 'M', link: 'https://pag.ae/81M-Zz4cL' }, { size: 'G', link: 'https://pag.ae/81M-QYczq' }],
  ...
  },
  {
    ...
    subtitle: 'Design que descansa e protege. Estrutura em madeira natural com sisal trançado que serve de cama, arranhador e companheiro de viagem — dobrável para ir onde o seu gato for. Descanso com design. Proteção elegante para seus móveis.',
