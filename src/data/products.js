...
export const PRODUCTS = [
  ...
  {
    id: 23,
    name: 'Tapete Minimalista para Alimentação | Design Sofisticado',
    shortName: 'Tapete Minimalista',
    subtitle: 'Elegância e proteção para o cantinho do seu pet.',
    description: 'O Tapete Minimalista para Alimentação foi criado para unir praticidade, organização e estética refinada em um único produto. Seu design moderno e sofisticado protege o piso contra respingos de água e ração, enquanto adiciona um toque de elegância ao ambiente — porque cada detalhe do lar do seu pet merece atenção.',
    bullets: [
      'Superfície antiderrapante para maior segurança',
      'Proteção completa contra sujeira e umidade',
      'Design minimalista e decorativo',
      'Material resistente e fácil de limpar',
      'Praticidade no dia a dia',
      'Combina com ambientes modernos e sofisticados',
    ],
    price: 'R$ 89,90',
    originalPrice: null,
    category: ['a-mesa'],
    image: '/images/products/tapete_minimalista.webp',
    badge: null,
    buyLink: 'https://pag.ae/81NPqmtVr',
  },
];
